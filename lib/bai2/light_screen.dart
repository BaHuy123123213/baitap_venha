  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
          ...
          color: const Color.fromARGB(255, 178, 156, 156).withOpacity(0.5)),
      child: Row(
...
class MyHomePageLight extends StatelessWidget {
  const MyHomePageLight({super.key});
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SvgPicture.asset('assets/svg/WeatherIcon - 1-46.svg'),
                          const Text(
                            'Soft light',
                            style: TextStyle(
                                fontSize: 24,
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(12),
                                color: const Color.fromARGB(255, 178, 156, 156)
                                    .withOpacity(0.5)),
                            child: Column(
                              children: [
                                Row(
